...
@referers = ('ellipsisdesign.com','64.70.173.133');
...
sub parse_form {
    ...
    %Config = ('recipient','',          'subject','',
               'email','',              'realname','',
               'redirect','http://www.ellipsisdesign.com/thanks.html',           'bgcolor','#000000',
               'background','',         'link_color','#B75E22',
               'vlink_color','#666666',        'text_color','#7D8EA2',
               'alink_color','',        'title','Thank You for Contacting Ellipsis Design.',
               'sort','',               'print_config','',
               'required','',           'env_report','',
