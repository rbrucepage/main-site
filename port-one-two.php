...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-1-2-1-2.jpg" title="Venomous2000 & Tahir Jahi, Produced by Chopzilla: One, Two, One, Two" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_1-2-1-2.png" alt="Still Connected album artwork" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-1-2-1-2.jpg" title="Venomous2000 & Tahir Jahi, Produced by Chopzilla: One, Two, One, Two" class="lb_overlay">Tahir Jahi & Venomous2000: <br>One, Two, One, Two</a></h3>
			<h5>CD single digital distribution artwork (cover)</h5>
			<div class="descriptive-block">Created artwork for the first featured track from the 2012 release of <em>Rampage</em> by producer Chopzilla. Full album still in development. Track includes samples from, and is inspired by the classic Chinese Kung Fu cinema. Full album art also in development. Stay tuned.</div>
		<br class="clear" />
		</div>
