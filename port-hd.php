...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.healthydirections.com" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-hd.png" alt="Big Idea Supply v2 website" class="scale-with-grid"></a>
			<h5>2011</h5>
			<h3><a href="http://www.healthydirections.com" target="_blank">Healthy Directions Brand Launch</a></h3>
			<h5>Healthy Directions</h5>
			<div class="descriptive-block">HealthyDirections.com was designed around the concept of it being the authoritative resource for natural health solutions, both content and product. It's feel is different from that of the doctor sites which were developed at the same time. It's more aspirational and education driven.</div>
		<br class="clear" />
		</div>
