...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.totalcustomerstrategy.com" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-TCS.png" alt="Total Customer Strategy website" class="scale-with-grid"></a>
			<h5>2013</h5>
			<h3><a href="http://www.totalcustomerstrategy.com/" target="_blank">Total Customer Strategy Website</a></h3>
			<h5>United Sales Resources</h5>
			<div class="descriptive-block">The first product launch for USR. This website was built to provide information on USR's Total Customer Strategy program and drive users to contact USR for additional information.</div>
		<br class="clear" />
		</div>
