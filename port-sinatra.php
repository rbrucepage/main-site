...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.drsinatra.com" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-sinatra.png" alt="Dr Sinatra website migration" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="http://www.drsinatra.com" target="_blank">Dr. Sinatra Website Redesign</a></h3>
			<h5>Healthy Directions</h5>
			<div class="descriptive-block">Working with a large team of developers, marketers, merchandisers, designers, writers, programmers and executive sponsors to launch this site was a learning experience. After developing the templates and platform functionality with the Dr. Williams site, we designed, developed, debugged and launched this site in 6 weeks. Amazing given the amount of content and functionality.
			</div>
		<br class="clear" />
		</div>
