...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-bs-logo.jpg" title="Beetle Surveillance logo" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-mf-beetle-survalence.png" alt="Beetle Surveillance logo" class="scale-with-grid"></a>
			<h5>2002</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-bs-logo.jpg" title="Beetle Surveillance logo" class="lb_overlay">Beetle Surveillance logo</a></h3>
			<h5>Beetle Surveillance</h5>
			<div class="descriptive-block">The Beetle Surveillance logo was developed to promote the Beetle Surveillance Spy Equipment Company. The "bug" metaphor is played up and a camera was strapped to it's back to communicate the idea of bugging as it pertains to surveillance.</div>
		<br class="clear" />
		</div>
