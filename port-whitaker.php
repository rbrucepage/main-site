...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.drwhitaker.com" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-whitaker.png" alt="Dr. Whitaker platform migration" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="http://www.drwhitaker.com" target="_blank">Dr. Whitaker Website Redesign</a></h3>
			<h5>Healthy Directions</h5>
			<div class="descriptive-block">This was the last of the sites we developed on the WebLinc platform. This site launched in 4 weeks from kick-off. The design is meant to communicate the political stance Dr. Whitaker takes with regards to alternative medicine. There were many cues taken from the White House website and others when benchmarking during the design phase.</div>
		<br class="clear" />
		</div>
