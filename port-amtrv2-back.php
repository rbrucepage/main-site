...
<body class="portfolio-page graphics">
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-amtrv2-back.jpg" title="Venomous2000: A Moment to Reflect, Vol 2, Rear Cover" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_amtrv2-rear-cover-400x417.png" alt="Still Connected album artwork" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-amtrv2-back.jpg" title="Venomous2000: A Moment to Reflect, Vol 2, Rear Cover" class="lb_overlay">Venomus2000: A Moment to Reflect, Vol. 2</a></h3>
			<h5>CD packaging design (tray insert)</h5>
			<div class="descriptive-block">Created artwork for the 2012 release of <em><a href="http://venomous2000.bandcamp.com/album/a-moment-to-reflect-ii" target="_blank">A Moment to Reflect, Vol. 2</a></em> by respected New Jersey hip-hop artist Venomous2000. Project included a jewel case cover, tray insert, CD and the rear of the case. Project also features graffiti from artists Demer, Kasso and Tise Shr. Album is a collection of musical collaborations featuring Venomous2000. One notable track including, and produced by, Inspectah Deck of Wu-Tang.</div>
		<br class="clear" />
		</div>
		
		
		<?php include ("includes/portfolio-graphics.php"); ?>
