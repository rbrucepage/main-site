...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-v2k-promo.jpg" title="Venomous2000: Promotional Graphics" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_v2k-promo-400x417.png" alt="Still Connected album artwork" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-v2k-promo.jpg" title="Venomous2000: Promotional Graphics" class="lb_overlay">Venomus2000: Jersey Promotional Graphics</a></h3>
			<h5>Promo art, Flyer art</h5>
			<div class="descriptive-block">Venomous2000 promo art for flyers, posters and graphic promotions. Artwork pays homage to life in the city of New Jersey as the sun rises above it. The design was meant to communicate the feeling of living in the city. It's gritty, complex and busy, but at the same time harmonic and beautiful. There's also an intentional nod to the great RUN-DMC. Legends in east-coast hip-hop.</div>
		<br class="clear" />
		</div>
