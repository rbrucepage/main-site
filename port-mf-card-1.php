...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-mf-card-3.jpg" title="Medium Fusion Postcard 1/8" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-mf-card-1.png" alt="MediumFusion promo card set 1 of 8" class="scale-with-grid"></a>
			<h5>2002</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-mf-card-3.jpg" title="Medium Fusion Postcard 1/8" class="lb_overlay">mediumFUSION Promotional Postcard (1 of 8)</a></h3>
			<h5>mediumFUSION Graphic Arts Group</h5>
			<div class="descriptive-block">A set of 8 promotional postcards were developed for the mediumFUSION Graphics Art Group that were meant to reinforce art as design. Each postcard was unique and was tied to an overall theme that everything in nature is designed and part of a larger whole. This design spoke to the structure and design of typography, and suggests that the structural design of type is not so different from the design of natural living things.</div>
		<br class="clear" />
		</div>
