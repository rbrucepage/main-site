...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.bladderreliefpackage.com/ver1/" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-bladder-relief.png" alt="Bladder Relief Sales Letter" class="scale-with-grid"></a>
			<h5>2010</h5>
			<h3><a href="http://www.bladderreliefpackage.com/ver1/" target="_blank">Bladder Relief Online Sales Letter</a></h3>
			<h5>Premier Direct</h5>
			<div class="descriptive-block">This is probably the most consumable long-form landing page we've created to date. It's entry is easy, and the copy starts short. The text size, color and line height are perfect for this style of page. It's easy to read, or skim, and is well organized. It's a long page, so having many calls-to-action became highly important.</div>
		<br class="clear" />
		</div>
