...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-locked-up.jpg" title="Locked Up" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_locked-up.png" alt="Still Connected album artwork" class="scale-with-grid"></a>
			<h5>2011</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-locked-up.jpg" title="Locked Up" class="lb_overlay">Locked Up</a></h3>
			<h5>Pencil Illustration and Photoshop Fun</h5>
			<div class="descriptive-block">An experimentation in mood, texture and color. Elements like the small tree in the bottom right corner and the flourishes on the typeface are meant to counterbalance the otherwise claustrophobic design. Really did this cause I felt like playing with Photoshop. Keeping the skills sharp.</div>
		<br class="clear" />
		</div>
