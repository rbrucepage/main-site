...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.drdavidwilliams.com" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-williams.png" alt="Big Idea Supply v2 website" class="scale-with-grid"></a>
			<h5>2011</h5>
			<h3><a href="http://www.drdavidwilliams.com" target="_blank">Dr. David Williams Website Redesign</a></h3>
			<h5>Healthy Directions</h5>
			<div class="descriptive-block">Beyond redesigning and migrating a site containing more than 1,000 unique pages, this site saw major technical updates as part of it's facelift. The shopping experience was redesigned from end-to-end. The site also launched the new branding for Dr. David Williams. All product and marketing collateral had to be redesigned as part of the website's launch strategy.</div>
		<br class="clear" />
		</div>
