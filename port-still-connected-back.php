...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-still-connected-v2-back.jpg" title="Venomous2000 & Kingshon: Still Connected Vol 2, Rear Cover" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_still-connected-back.png" alt="Still Connected album artwork" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-still-connected-v2-back.jpg" title="Venomous2000 & Kingshon: Still Connected Vol 2, Rear Cover" class="lb_overlay">Venomus2000 & Kingshon: Still Connected</a></h3>
			<h5>CD packaging design (tray insert)</h5>
			<div class="descriptive-block">Created artwork for the 2012 release of <em><a href="http://venomous2000.bandcamp.com/releases" target="_blank">Still Connected, vol. 2</a></em> by respected New Jersey hip-hop artists Venomous2000 and Kingshon. Project included a jewel case cover, tray insert, disc artwork and the rear of the case. Artwork was designed around the concept of energy transference and the symbiotic relationship between all living things.</div>
		<br class="clear" />
		</div>
