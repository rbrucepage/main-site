...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-mf-card-2.jpg" title="Medium Fusion Postcard 2/8" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-mf-card-2.png" alt="MediumFusion promo card set 2 of 8" class="scale-with-grid"></a>
			<h5>2002</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-mf-card-2.jpg" title="Medium Fusion Postcard 2/8" class="lb_overlay">mediumFUSION Promotional Postcard (2 of 8)</a></h3>
			<h5>mediumFUSION Graphic Arts Group</h5>
			<div class="descriptive-block">A set of 8 promotional postcards were developed for the mediumFUSION Graphics Art Group that were meant to reinforce art as design. Each postcard was unique and was tied to an overall theme that everything in nature is designed and part of a larger whole. This design depicts the design of the tools that are used in design, by showing their inner components. This speaks to the notion that all things are "designed" to work in a specific manor. Natural or not.</div>
		<br class="clear" />
		</div>
