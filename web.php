...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.oscarsalehouse.net" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-oscars.png" alt="Oscar's Alehouse" class="scale-with-grid"></a>
			<h5>2013</h5>
			<h3><a href="http://www.oscarsalehouse.net" target="_blank">Oscar's Alehouse Website</a></h3>
			<h5>Oscar's Alehouse</h5>
			<div class="descriptive-block">A mobile-responsive website. Designed on a custom-built CMS, which is responsive as well. The website is easy for the customer to manage regardless of accessible platform.</div>
		<br class="clear" />
		</div>
