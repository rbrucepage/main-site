...
<!-- [Your confirmation message goes here] -->
    ...
    <p>Your message has been sent. Thanks much! 
...
Thanks for reaching out. I've received your message and will be in touch soon.
%DataOfForm%
...
$GLOBALS['form_mail']['field_3'] = array( "name" => "field_3", "text" => "website",  "type" => "text", "instruction" => "website url", "required" => "" ) ;
$GLOBALS['form_mail']['field_4'] = array( "name" => "field_4", "text" => "company",  "type" => "text", "instruction" => "company name", "required" => "" ) ;
