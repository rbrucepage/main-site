...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Who is The Big Idea Supply Company</title>
...
<div class="outerBox">
	...
	<div class="container center-content">
		<div class="eleven columns bottom-margin">
			<h2 class="article-top">We're The Big Idea Supply Co.</h2>
	        <p>We make successful, user-focused websites. We love what we do.</p>
	        <p>We create simple, intuitive yet powerful interfaces. Creative UIs that compel action and communicate clearly their intent. Beautiful design that gets out of the way.</p>
	        <p>We are personally gratified through the solutions we provide for clients. We just can't seem to get enough of it. We want our work to be meaningful, successful and challenging.</p>
	        <h2>EVERYTHING communicates.</h2>
			<p>Not saying anything &mdash; or the wrong thing &mdash; can communicate just as much as saying something. That's why it's so important to say <em>the right thing</em>. You never know what it could be about the experience that causes the user to <em>not</em> act. Call the Big Idea Supply Company. We'll use our Jedi powers on them... Or maybe just provide the perfect environment for them to do what ever it is they're needing to.</p>
