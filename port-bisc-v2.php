...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="v2/index.html" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-bisc-v2.png" alt="Big Idea Supply v2 website" class="scale-with-grid"></a>
			<h5>2011</h5>
			<h3><a href="v2/index.html" target="_blank">The Big Idea Supply Co.</a></h3>
			<h5>Version 2.0 Website</h5>
			<div class="descriptive-block">Version 2.0 began as an experimentation in simplicity. What are the essential elements needed for content distribution on the internet? Simple communication became the theme of the site. It was clean and functional. It's design was meant to get out of the way and facilitate content consumption. But still appear refined and have it's own personality.</div>
		<br class="clear" />
		</div>
