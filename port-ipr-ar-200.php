...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="/images/portfolio/full/bisc-artwork-full-ipr-ar.jpg" title="Indianapolis Parks & Recreation Annual Report" class="lb_overlay opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-ipr-ar-2000.png" alt="Indianapolis Parks & Recreation Anual Report, 2000" class="scale-with-grid"></a>
			<h5>2000</h5>
			<h3><a href="/images/portfolio/full/bisc-artwork-full-ipr-ar.jpg" title="Indianapolis Parks & Recreation Anual Report" class="lb_overlay">Annual Report, 2000</a></h3>
			<h5>Indianapolis Parks and Recreation</h5>
			<div class="descriptive-block">Working with mediumFUSION in Indianapolis, we developed the annual report for Indianapolis Parks and Recreation. Along with the Annual Report was a custom designed folder to hold the report. The covers were designed in 5 color, with the fifth color being a spot varnish. We also developed the 2001 annual report the following year.</div>
		<br class="clear" />
		</div>
