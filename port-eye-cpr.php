...
<div class="outerBox">
	...
	<div class="container center-content">
		...
		<div class="seven columns featured-art">
			<a href="http://www.healthydirections.com/tabor-eye-cpr" target="_blank" class="opacity"><img src="images/portfolio/bisc-v3-960g_portfolio-eye-cpr.png" alt="Dr. Tabor Eye CPR Landing Page" class="scale-with-grid"></a>
			<h5>2012</h5>
			<h3><a href="http://www.healthydirections.com/tabor-eye-cpr" target="_blank">Dr. Tabor's EyeCPR Product Micro-Site</a></h3>
			<h5>Healthy Directions</h5>
			<div class="descriptive-block">We are determined to change the UX model of the long-form landing page. We took an opportunity with this project. Some features include a sticky nav bar, an accordion-style content reveal to simplify the page, a sticky call to action tab allowing easy, on-demand purchasing. Optimized, approachable text and graphic treatments to encourage consumption.</div>
		<br class="clear" />
		</div>
